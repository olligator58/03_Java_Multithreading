package Task60150.client;

import Task60150.Connection;
import Task60150.ConsoleHelper;
import Task60150.Message;
import Task60150.MessageType;
    ...
    public void run() {
        ...
        synchronized (this) {
            try {
                ...
                ConsoleHelper.writeMessage("При соединении с сервером произошла ошибка...");
                return;
            }
        }
