...
public class Task4092 {
    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                Double profit1 = getProfit(stock1);
                Double profit2 = getProfit(stock2);
                return profit2.compareTo(profit1);
            }
        });
    }

    private static double getProfit(Stock stock) {
        double result;
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Apple Inc.", "AAPL", 125.64, 120.43));//
        stocks.add(new Stock("Fake Apple Inc.", "AAPL", 125.64, 130.43));//
        ...
        stocks.add(new Stock("Fake Nokia Corporation (ADR)", "NOK", .58, getRandomDate()));
        stocks.add(new Stock("Fake Nokia Corporation (ADR)", "NOK", .2, getRandomDate()));
